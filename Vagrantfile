...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "chase_gilliam-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/chasegilliamtest"
  #   chef.validation_client_name = "chasegilliamtest-validator"
  #   chef.validation_key_path = ".chef/chasegilliamtest-validator.pem"
  # end
end
